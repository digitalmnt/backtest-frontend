...
export default function AddLiquidity({
  ...
  const [btType, updateBtType] = useState('')
        ...
        <PageWrapper wide={!hasExistingPosition}>
          ...
          <Wrapper>
                  ...
                  <AutoColumn gap="md">
                    ...
                    <StyledInput
                      ...
                      onUserInput={(val) => {
                        ...
                        // hacky way to simulate position. since values go back in time currency ratio is not accurate
                        onFieldAInput(val)
                      }}
                    />
                    {/* <CurrencyInputPanel
            ...
            <BackTest
              ...
              position={position}
              theme={theme}
              fiatValue={depositAmount}
              hasPosition={usdcValues[Field.CURRENCY_A] && usdcValues[Field.CURRENCY_B]}
              updateBTParentType={(btType) => updateBtType(btType)}
            />
            {!hasExistingPosition ? (
              <>
                <HideMedium>
